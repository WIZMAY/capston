 ...
 * Generated at: 2021-05-02 12:00:38 UTC
...
return;
    ...
    try {
      ...
      out.write("            document.getElementById(\"userId\").value = opener.document.joinpol.user_id.value;\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function isIdValid(id){\r\n");
      out.write("        \tfor(var i =0; i< id.length;i++){\r\n");
      out.write("        \t\tvar c = id.charAt(i);\r\n");
      out.write("        \t\tif((c < \"0\" || c > \"9\") && (c < \"A\" || c > \"Z\") && (c < \"a\" || c > \"z\"))\r\n");
      ...
      out.write("                return false;\r\n");
      out.write("            } \r\n");
      out.write("            else if(isIdValid(id)){ \r\n");
      out.write("                alert(\"한글 및 특수문자는 아이디로 사용하실 수 없습니다.\");\r\n");
      out.write("                return false;\r\n");
      out.write("            }\r\n");
      out.write("            else if((id.length < 6)||(id.length > 16)){\r\n");
      out.write("            \talert(\"최소 6자 이상 16자 이하로 입력하세요.\");\r\n");
      out.write("            \treturn false;\r\n");
      out.write("            }\r\n");
      out.write("            else\r\n");
      out.write("            {\r\n");
      ...
      out.write("                httpRequest.open(\"POST\", \"/MemberIdCheck.jsp\", true);  \r\n");
      ...
      out.write("               \r\n");
      out.write("                if(resultText.charAt(0) == \"0\"){\r\n");
      ...
      out.write("                } \r\n");
      out.write("                else if(resultText.charAt(0) == \"1\"){ \r\n");
      ...
      out.write("            opener.document.joinpol.idDuplication.value =\"idCheck\";\r\n");
      out.write("            // 회원가입 화면의 ID입력란에 값을 전달\r\n");
      out.write("            opener.document.joinpol.user_id.value = document.getElementById(\"userId\").value;\r\n");
      out.write("            \r\n");
